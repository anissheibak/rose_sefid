...
Route::prefix('admin')->namespace('Admin')->group(function () {
    ...
    Route::prefix('market')->namespace('Market')->group(function () {
        ...
        Route::prefix('category')->group(function () {
            ...
            Route::get('/showInMenu/{productCategory}', [CategoryController::class, 'showInMenu'])->name('admin.market.category.show-in-menu');
        });
        ...
        Route::prefix('discount')->group(function () {
            ...
            Route::post('/copan/store', [DiscountController::class, 'copanStore'])->name('admin.market.discount.copan.store'); Route::get('/amazing-sale/edit/{amazingSale}', [DiscountController::class, 'amazingSaleEdit'])->name('admin.market.discount.amazingSale.edit');
        ...
        Route::prefix('order')->group(function () {
            ...
            Route::get('/show/{order}/details', [OrderController::class, 'details'])->name('admin.market.order.show.details');
    ...
    Route::prefix('content')->namespace('Content')->group(function () {
        ...
        Route::prefix('menu')->group(function () {
            ...
            Route::get('/status/{menu}', [MenuController::class, 'status'])->name('admin.content.faq.status');
        });
    ...
    Route::prefix('ticket')->namespace('Ticket')->group(function () {
        ...
        Route::prefix('admin')->group(function(){
            ...
            Route::get('/sett/{admin}', [TicketAdminController::class, 'set'])->name('admin.ticket.admin.set');
        });
