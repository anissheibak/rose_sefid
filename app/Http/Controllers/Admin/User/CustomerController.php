...
class CustomerController extends Controller
{
    ...
    public function store(CustomerRequest $request, ImageService $imageService)
    {
        ...
        if($request->hasFile('profile_photo_path')){
            ...
            if($result === false){
                return redirect()->route('admin.user.customer.create')->with('swal-error', 'آپلود تصویر با خطا مواجه شد.');
            }
    ...
    {
        $user->forceDelete();
        return redirect()->route('admin.user.customer.index')->with('swal-error','کاربر مشتری با موفقیت حذف شد.');
    }
