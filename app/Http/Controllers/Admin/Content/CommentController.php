...
class CommentController extends Controller
{
    ...
    public function approved(Comment $comment)
    {
        ...
        $result = $comment->save();
        if($result){
            return redirect()->route('admin.content.comment.index')->with('swal-success', 'وضعیت تایید نظر با موفقیت تغییر کرد.');
        }
        else{
            return redirect()->route('admin.content.comment.index')->with('swal-error', 'وضعیت تایید نظر با خطا مواجه شد.');
        }
    }
