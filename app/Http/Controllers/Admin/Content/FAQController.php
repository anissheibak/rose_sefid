...
class FAQController extends Controller
{
    ...
    public function store(FaqRequest $request)
    {
        ...
        return redirect()->route('admin.content.faq.index')->with('swal-success', 'پرسش و پاسخ جدید با موفقیت ثبت شد.');
    }
    ...
    public function update(FaqRequest $request, Faq $faq)
    {
        $inputs = $request->all();
        $faq->update($inputs);
        return redirect()->route('admin.content.faq.index')->with('swal-success', 'پرسش و پاسخ  با موفقیت ویرایش شد.');
    }
    ...
    {
        $faq->delete();
        return redirect()->route('admin.content.faq.index')->with('swal-error', 'پرسش و پاسخ با موفقیت حذف شد.');
    }
