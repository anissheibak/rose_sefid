...
return [
    ...
    */
    ...
    "confirmed"        => ":attribute با فیلد تاییدیه مطابقت ندارد.",
    ...
    'password' => [
        ...
        'symbols' => ':attribute باید شامل حداقل یک کاراکتر خاص(مثل: %, $, #, ...) باشد.',
        'uncompromised' => 'مقدار انتخاب شده برای :attribute مناسب نیست.',
    ],
