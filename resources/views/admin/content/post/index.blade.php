                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <label for="">
                                        <input id="{{$post->id}}" onchange="changeStatus({{$post->id}})" data-url="{{ route('admin.content.post.status', $post->id) }}" type="checkbox" @if ($post->status === 1) checked @endif>
                                    </label>
                                </td>
                                <td>
                                    <label for="">
                                        <input id="{{$post->id}}-commentable" onchange="commentable({{$post->id}})" data-url="{{ route('admin.content.post.commentable', $post->id) }}" type="checkbox" @if ($post->commentable === 1) checked @endif>
                                    </label>
                                </td>
