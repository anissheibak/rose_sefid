                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>{{$comment->parent_id ? Str::limit($comment->parent->body, 25) : ''}}</td>
                            ...
                            <td class="width-16-rem text-center">
                                ...
                                <a href="{{ route('admin.content.comment.approved', $comment->id) }}" class="btn btn-warning btn-sm text-white" type="submit"><i class="fa fa-clock"></i> عدم تایید</a>
                                @else
                                <a href="{{ route('admin.content.comment.approved', $comment->id) }}" class="btn btn-success btn-sm text-white" type="submit"><i class="fa fa-check-circle"></i>  تایید</a>
                                @endif
                            </td>
                        </tr>
                        @endforeach
