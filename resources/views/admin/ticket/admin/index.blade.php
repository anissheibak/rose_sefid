                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="width-16-rem text-left">
                                <a href="{{ route('admin.ticket.admin.set', $admin) }}" class="btn btn-{{$admin->ticketAdmin == null ? 'success' : 'danger'}} btn-sm"><i class="fa fa-{{$admin->ticketAdmin == null ? 'user-plus' : 'user-times'}}"></i>
