...
@section('head-tag')
<title>ویرایش مقدار فرم محصول</title>
@endsection
...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
      ...
      <li class="breadcrumb-item font-size-12 active" aria-current="page"> ویرایش مقدار فرم محصول</li>
    </ol>
  </nav>
  ...
  <section class="row">
    <section class="col-12">
        <section class="main-body-container">
            ...
            <section>
                <form action="{{ route('admin.market.value.update', ['value' => $value->id, 'attribute' => $attribute->id]) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <select name="product_id" id="" class="form-control form-control-sm">
                                    ...
                                    <option value="{{$product->id}}" @if (old('product_id', $product->id) == $product->id) selected @endif>{{$product->name}}</option>
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-sm" name="value" value="{{old('value', json_decode($value->value)->value)}}">
                            </div>
                            @error('value')
                                <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                    <strong>
                        ...
                        <section class="col-12 col-md-6 my-2">
                            <div class="form-group">
                                ...
                                <select name="type" id="type" class="form-control form-control-sm">
                                    <option value="0" @if (old('type', $value->type)==0) selected @endif>ثابت</option>
