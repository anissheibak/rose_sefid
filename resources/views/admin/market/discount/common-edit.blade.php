                    ...
                    <section class="row">
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="start_date" id="start_date" class="form-control form-control-sm d-none" value="{{ jalaliDate($commonDiscount->start_date) }}">
                                <input type="text" id="start_date_view" class="form-control form-control-sm"  value="{{ jalaliDate($commonDiscount->start_date) }}">
                            </div>
                            @error('start_date')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
                        ...
                        <section class="col-12 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="end_date" id="end_date" class="form-control form-control-sm d-none"  value="{{ jalaliDate($commonDiscount->end_date) }}">
                                <input type="text" id="end_date_view" class="form-control form-control-sm"  value="{{ jalaliDate($commonDiscount->end_date) }}">
                            </div>
                            @error('end_date')
                            <span class="alert_required bg-danger text-white p-1 rounded" role="alert">
                                <strong>
